(() => {
    ...
    function headerScroll() {
        ...
        const startPoint = header.dataset.scroll ? header.dataset.scroll : 38;
    ...
    da.init();
    const BTN_ESTATE_01 = document.getElementById("btn-estate-01");
    const BODY_ESTATE_01 = document.getElementById("body-estate-01");
    const BTN_ESTATE_02 = document.getElementById("btn-estate-02");
    const BODY_ESTATE_02 = document.getElementById("body-estate-02");
    const BTN_ESTATE_03 = document.getElementById("btn-estate-03");
    const BODY_ESTATE_03 = document.getElementById("body-estate-03");
    if (BTN_ESTATE_01 !== null) BTN_ESTATE_01.addEventListener("click", (e => {
        BTN_ESTATE_01.classList.toggle("button-estate-active");
        BODY_ESTATE_01.classList.toggle("body-estate-active");
    }));
    if (BTN_ESTATE_02 !== null) BTN_ESTATE_02.addEventListener("click", (e => {
        BTN_ESTATE_02.classList.toggle("button-estate-active");
        BODY_ESTATE_02.classList.toggle("body-estate-active");
    }));
    if (BTN_ESTATE_03 !== null) BTN_ESTATE_03.addEventListener("click", (e => {
        BTN_ESTATE_03.classList.toggle("button-estate-active");
        BODY_ESTATE_03.classList.toggle("body-estate-active");
    }));
    const periods = document.querySelectorAll(".body-confirm__period");
    if (true) periods.forEach((period => {
        const buttons = period.querySelectorAll(".nav-body-confirm__button");
        buttons.forEach((button => {
            button.addEventListener("click", (() => {
                buttons.forEach((btn => {
                    btn.classList.remove("button-confirm-active");
                }));
                button.classList.add("button-confirm-active");
            }));
        }));
    }));
    const BTN_COKIE = document.getElementById("btn-cokie");
    const COKIE = document.querySelector(".cokie");
    if (COKIE !== null) BTN_COKIE.addEventListener("click", (e => {
        COKIE.classList.toggle("cokie-disable");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
